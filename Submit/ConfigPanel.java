...
public class ConfigPanel extends JPanel {
	...
	public void LoadVisualItems(){
		...
		fslblFunctionSet = new ClassSetPanel(owner, "Function", Function.class);
		...
		cspMutators = new ModifierSetPanel(owner, "Mutator", Mutator.class, erredList);
		...
		cspCrossovers = new ModifierSetPanel(owner, "Crossover", Crossover.class, erredList);
	...
	private void LoadFitnessProcess() {
		ClassInformation ci = new ClassInformation();
		ClassSelector.getClassOfType(owner, FitnessProcess.class, ci);
		if( ci.file.equals("")) return;
	...
	private void LoadSelectionProcess() {
		ClassInformation ci = new ClassInformation();
		ClassSelector.getClassOfType(owner, SelectionMethod.class, ci);
		if( ci.file.equals("")) return;
